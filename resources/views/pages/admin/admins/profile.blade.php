<div class="flex flex-col gap-3 w-full p-6 bg-white rounded-3xl">
    <div class="flex flex-row gap-5">
        ...
        <div class="flex flex-col gap-2 w-full">
            ...
            <div class="grid grid-cols-2 gap-1 w-full">
                <x-mini-detail title="Name" value="{{ $data->name }}" />
    ...
    @if ($data->lastActivity())
        <div class="px-6 py-2 bg-gray-less rounded-xl font-medium mb-1">
            <div class="text-sm text-black-less">Last Activity</div>
            <div class="text-base">{{ $data->lastActivity()->description ?? '' }}</div>
        </div>
    @endif
</div>
