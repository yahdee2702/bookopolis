<div @class([
    ...
    <img src="{{ $data->image }}" class="aspect-1 w-36 h-36 rounded-l-xl object-cover object-center" alt="">
    <div class="w-full h-full flex flex-col justify-between flex-1 px-4 py-3">
        ...
        <div @class([
            ...
            <div class="flex flex-row gap-1 items-center">
                <img src="{{ $data->seller->image }}" class="aspect-1 w-5 h-5 rounded-full object-cover object-center" alt="">
